<<<<<<< Updated upstream:source/Vector3D.cpp
...
double Vector3D::mag(void){
	...
	Vector3D V3Drotate(Vector3D v,Vector3D angle){
		...
		t[0][2]=a[1][2]*a[0][1]*a[1][0]+a[0][2]*a[0][0];
		t[1][1]=a[0][2]*a[0][1]*a[0][0]+a[1][2]*a[1][0];
		t[1][2]=a[0][2]*a[0][1]*a[1][0]-a[1][2]*a[0][0];
		t[1][0]=a[0][2]*a[1][1];
		t[2][0]=-a[0][1];
		t[2][1]=a[1][1]*a[0][0];
		t[2][2]=a[1][1]*a[1][0];
...
void Vector3D::display(){
	std::cout<<"("<<this->x<<", "<<this->y<<" ,"<<this->z<<")";
>>>>>>> Stashed changes:source1/Vector3D.cpp
}