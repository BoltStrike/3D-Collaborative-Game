...
int main()
{
	std::cout << "a"<<std::endl<<std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl;
	...
	// ------------------------------------
	Shader ourShader("source/7.3.camera.vs", "source/7.3.camera.fs");
